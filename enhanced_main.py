...
Integrated Main Module with Enhanced Features

This is the main entry point with additional utilities
"""
...
from config import GUI_CONFIG, DIAGNOSTICS_THRESHOLDS
